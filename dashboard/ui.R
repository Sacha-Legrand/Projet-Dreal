    ...
    dashboardBody(
        ...
        tabItems(
            ...
            tabItem(tabName = "sub_menu_contexte",
                    ...
                    fluidRow(
                        column(width=8,
                          ...
                          En effet, elle peut avoir une influence sur la croissance [",
                          actionLink("bib1", "1"),
                          "][",
                          actionLink("bib2", "2"),
                          "], la reproduction
                          et le développement des poissons, ainsi que de leurs embryons et larves [",
                          actionLink("bib3", "3"),
                          "].
                          ...
                          diminution de l'oxygène dissous, qui est essentiel à la vie aquatique [",
                          actionLink("bib4", "4"),
                          "][",
                          actionLink("bib5", "5"),
                          "]."),
                          ...
                          p(style="text-align: justify;",
                            "Depuis les années 70, la température des grands fleuves est
                         étudiée en France [",
                         actionLink("bib6", "6"),
                         "][",
                         actionLink("bib7", "7"),
                         "][",
                         actionLink("bib8", "8"),
                         "], et depuis 2008, grâce à la
                          création d'un réseau national par l'Office Français de
                          la Biodiversité (OFB), la surveillance environnementale
                          de la température des rivières s'est généralisée.
                          Toutefois jusqu’à récemment, l’étude approfondie de la
                          température des cours d’eau est restée rare, mise à part pour
            ...
            tabItem(tabName = "sub_menu_lexique",
                    ...
                    de la mer en mètre Nivellement Général Français (NGF) [",
                    actionLink("bib15bis", "15"),
                    "]."),
                    ...
                    p(style="text-align: justify;",
                      ...
                      multivariées parfois de grandes dimensions [",
                      actionLink("bib17", "17"),
                      "]. "),
                    ...
                    p(style="text-align: justify;",
                      ...
                      actionLink("bib18", "18"),
                      "], tels qu’un signal nappe phréatique
                        ...
                        tabPanel(strong("Description"),
                                 ...
                                 fluidRow(
                                     ...
                                     column( width = 9,
                                             ...
                                             p(style="text-align: justify;",
                                                 "Quelques tendances générales peuvent se dégager
                                               par rapport aux températures des eaux de la Touques
                                               enregistrées par les différentes sondes."),
                                             p(style="text-align: justify;",
                                                 "Notamment, les températures moyennes augmentent
                                               d'amont en aval, passant de ",
                                               paste0(round(db_stats_g_touques[1,5],3)),
                                               " en T1 à ",
                                               paste0(round(db_stats_g_touques[4,5],3)),
                                               " en T6 (soit une augmentation de ",
                                               paste0(
                                                   round((db_stats_g_touques[4,5]/
                                                              db_stats_g_touques[1,5]-1)*100,3)

                                                      ),
                                               " %)."
                                               ),
                                             tableOutput("touques_desc_g")
                                     )
                                     ),

                                    br(),
                                 h4("Pour en savoir plus"),
                                 p("Pour aller plus loin dans l'analyse descriptive,
                                   le tableau suivant permet de connaître les statistiques
                                   élémentaires d'années en années, pour chaque sonde. "),
                        ...
                        tabPanel(strong("Températures"),
                                 ...
                                 tabsetPanel(
                                     ...
                                     tabPanel("Températures lissées sur 30 jours",
                                              br(),
                                              p(style="text-align: justify;",
                                                "Les températures lissées sur 30 jours permettent de rendre compte des chroniques
                                                en absorbant les fluctuations transitoires qui peuvent exister dans les chroniques
                                                brutes.
                                                Par ailleurs, l’analyse des minima et maxima journaliers lissés sur 30 jours
                                                permettent de dégager des tendances plus générales concernant l’augmentation des
                                                températures."),



                                            p(style="text-align: justify;",
                                              "Au niveau du fleuve de la Touques, toutes les sondes présentent des tendances de températures maximales
                                              lissées sur 30 jours à la hausse. Les minima aussi montrent une tendance à la hausse,
                                              mis à part pour la sonde T6, la plus proche de la mer, qui semble même diminuer
                                              au fil des années."),
                                            ...
                                            h3("Une tendance à la hausse des températures d'eau de la Touques"),
                                              fluidRow(
                                              ...
                                              h4("Des augmentations de températures maximales à
                                                 la hausse") ,

                                              tableOutput("db_Touques_stats_MM30_An2"),


                                                  br(),br(),
                                            h4("Pour aller plus loin"),
                                                  p(style="text-align: justify;",
                                                 "Ce tableau fait le récapitulatif
                                                 des moyennes mensuelles moyennées à l'année des MM30
                                                 maximum et minimum
                                                 par sonde."),
                                    ...
                                    br(),
                                     p(style="text-align: justify;",
                                       "Les températures lissées sur 365 jours permettent une
                                       visualisation des chroniques désaisonnalisées."),

                                    p(style="text-align: justify;",
                                      "Les séries désaisonnalisées de la Touques montrent globalement
                                      une augmentation des températures, qui est toutefois moins
                                      nette concernant la sonde T6.
                                       De plus, les tendances des minima et maxima journaliers
                                       lissés sur l’année permettent de dégager des tendances
                                       similaires à celles du lissage sur 30 jours, avec plus de
                                       netteté."),
